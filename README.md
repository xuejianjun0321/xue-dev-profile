...
拥有超过 9 年 Java 开发经验，深度参与大型金融科技与电商项目，包括支付宝（3 年）和网易考拉（2 年）。具备丰富的云计算实践能力，拥有
4 年以上 SaaS 架构设计与团队管理经验。擅长分布式系统、高并发优化与低代码平台研发，热衷技术创新，致力于高质量代码与系统工程建设。
...
**浙江释普科技有限公司｜2022年6月 – 2023年7月**

- 同时参与多个企业数字化项目，负责后端架构与开发交付
- 封装通用功能为轻量 SDK，提高模块复用性与开发效率
- 开发内部代码生成工具，自动化 CRUD 模块搭建
- 构建低代码配置平台（MongoDB），支持拖拽配置、实时更新、多语言权限系统
- 按领域驱动设计（DDD）原则拆分系统模块，提升结构清晰度
- ⚡ **结果：** 平均开发效率提升 50%，动态配置上线零部署，中大型项目按期交付  
  **技术栈：** Java 11, Spring Boot, Spring Cloud, MongoDB, MySQL, Redis, Kafka, RocketMQ, Docker, Kubernetes, Jenkins

---

### **Java 架构师**

**杭州天眼智联科技有限公司｜2021年5月 – 2022年3月**

- 主导废料交易平台整体架构设计与核心功能开发
- 从 0 搭建技术团队，推动技术选型、文档规范、CI/CD 流程
- 构建包括 AI 模块、合同、账户、翻译、消息服务等子系统
- 保障部署弹性、监控预警及团队协作顺畅
- ⚡ **结果：** 3 个月内交付 MVP 平台并投入实际交易，稳定运行  
  **技术栈：** Java, Spring Boot, MyBatis, RocketMQ, Redis, Docker, Jenkins, Nginx, 阿里云

---

### **Java 开发专家**

**杭州天谷信息科技有限公司｜2019年12月 – 2021年4月**

- 主导企业级低代码平台架构设计与研发，封装流程/表单/模板引擎组件
- 制定项目规范，推进平台模块化与前后端分离
- 独立搭建 7 个系统，年产出代码超 12 万行，申请 2 项低代码专利
- ⚡ **结果：** 平台效率提升 3 倍，节省 342 个工作日  
  **技术栈：** Java 8, Spring Boot, Flowable, MyBatis, EasyRule, Groovy, Elasticsearch

---

### **高级 Java 开发工程师**

**网易无尾熊科技有限公司｜2017年8月 – 2019年6月**

- 主导交易系统服务化改造、性能优化与压测提升
- 拆分订单系统模块，构建灰度/风控/监控体系
- 数据迁移 Oracle → DDB & RDS，TPS 提升至 3000+  
  **技术栈：** Java 7, Spring, MyBatis, Oracle, Redis, Kafka, RabbitMQ

---

### **Java 开发工程师**

**蚂蚁金服（Ant Group）｜2014年6月 – 2017年7月**

- 负责蚂蚁聚宝离线计费系统架构与核心模块开发
- 基于 ODPS SQL + Shell 进行批量数据处理与对账任务调度
- 构建计费事件消息系统，重构系统架构，任务耗时由 12 小时优化至 40 分钟  
  **技术栈：** Java 5, Shell, ODPS SQL, Spring, Oracle, RabbitMQ, Redis
...
- 系统提升英语能力，研究德国就业市场与签证流程
- 成功获得德国“机会卡”签证并定居柏林，积极融入本地职场文化与技术生态
...
- 《一种亿级批量离线基金实时收益计算的方法》
- 《基于 easyRule 规则引擎配置化预测 flowable 工作流审批路径的方法》
- 《一种基于 Groovy 脚本动态清洗业务数据到 ElasticSearch 的方法》  
