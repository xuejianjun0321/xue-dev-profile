...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    /**
     * 将大写转化为下划线,首尾大写字母不会添加  "_"
     *
     * @param name
     * @return
     */
    public static String lowerCase_(String name) {
        if (isEmpty(name)) {
            return "";
        }
    ...
    public static void main(String[] args) {
        String abc = "event_wenhua_test";
        String toFUNName = toFUNName(abc);
        System.out.println(toFUNName);
        String abc1 = "t_mybatis_advance";
        String toFUNName1 = toFUNName(abc1);
        System.out.println(toFUNName1);

        System.out.println(underlineToHump(abc));
        System.out.println(underlineToHump(abc1));
    }
